" Base16 Equilibrium Gray Light vim-airline-theme (https://github.com/dawikur/base16-vim-airline-themes)
" For vim-airline (https://github.com/vim-airline/vim-airline)
" By Carlo Abelli

let s:scheme_slug = substitute("equilibrium-gray-light", "-", "_", "g")
