" Base16 Windows High Contrast Light vim-airline-theme (https://github.com/dawikur/base16-vim-airline-themes)
" For vim-airline (https://github.com/vim-airline/vim-airline)
" By Fergus Collins (https://github.com/C-Fergus)

let s:scheme_slug = substitute("windows-highcontrast-light", "-", "_", "g")
