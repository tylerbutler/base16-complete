" Base16 Synth Midnight Terminal Light vim-airline-theme (https://github.com/dawikur/base16-vim-airline-themes)
" For vim-airline (https://github.com/vim-airline/vim-airline)
" By Michaël Ball (http://github.com/michael-ball/)

let s:scheme_slug = substitute("synth-midnight-light", "-", "_", "g")
