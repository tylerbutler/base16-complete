...
gset string palette "#232136:#eb6f92:#3e8fb0:#ea9a97:#c4a7e7:#f6c177:#9ccfd8:#e0def4:#6e6a86:#eb6f92:#3e8fb0:#ea9a97:#c4a7e7:#f6c177:#9ccfd8:#56526e"
gset string palette "['#232136', '#eb6f92', '#3e8fb0', '#ea9a97', '#c4a7e7', '#f6c177', '#9ccfd8', '#e0def4', '#6e6a86', '#f6c177', '#2a273f', '#393552', '#908caa', '#e0def4', '#56526e', '#56526e']"
