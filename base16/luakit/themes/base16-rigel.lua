...
local base06 = "#fb94ff" -- +++
local base07 = "#e6e6dc" -- ++++
local base08 = "#c43061" -- red
local base09 = "#ff5a67" -- orange
local base0A = "#f08e48" -- yellow
local base0B = "#7fc06e" -- green
local base0C = "#00cccc" -- aqua/cyan
local base0D = "#1c8db2" -- blue
local base0E = "#c694ff" -- purple
local base0F = "#00ffff" -- brown
