...
local base06 = "#FF5C8F" -- +++
local base07 = "#FCE8C3" -- ++++
local base08 = "#EF2F27" -- red
local base09 = "#FF5F00" -- orange
local base0A = "#FBB829" -- yellow
local base0B = "#519F50" -- green
local base0C = "#0AAEB3" -- aqua/cyan
local base0D = "#2C78BF" -- blue
local base0E = "#E02C6D" -- purple
local base0F = "#2BE4D0" -- brown
